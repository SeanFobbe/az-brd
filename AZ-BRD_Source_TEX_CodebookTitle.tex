...
{ \scshape \Huge \bfseries Aktenzeichen  \\[0.7cm] \scshape \Huge \bfseries der \\[0.7cm] \scshape \Huge \bfseries Bundesrepublik Deutschland \\[0.7cm] \LARGE \bfseries (\datashort )};
